...
let endWithC3 = (message3 as string).endsWith('c'); // Runtime error, only if message3 = 3
let alternativeWay = (<string>message3).endsWith('c'); // Runtime error, only if message3 = 3
/*
$ tsc --target ES6 main5.ts | node main5.js
